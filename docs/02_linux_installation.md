...
Run the following command to install WSL (Windows Subsystem for Linux):
```
wsl.exe --install
```
_Note: If you are on a museum laptop, you will need to open PowerShell as an Administrator. You will be prompted to enter your admin login details._
